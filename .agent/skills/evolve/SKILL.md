---
name: evolve
description: 将相关 instinct 聚类进化为 skill、command 或 agent
---
...
1. Detect current project name, read instincts from `~/.claude/homunculus/instincts/global/` + `~/.claude/homunculus/instincts/projects/<project>/`
