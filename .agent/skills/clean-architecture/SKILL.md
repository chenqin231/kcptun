...
triggers:
  keywords:
    primary: [clean architecture, uncle bob, dependency rule, use case]
    secondary: [entity, boundary, interactor, presenter, gateway]
  context_boost: [layers, separation of concerns, testable, maintainable]
