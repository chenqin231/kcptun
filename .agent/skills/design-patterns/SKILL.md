...
triggers:
  keywords:
    primary: [design pattern, factory, observer, strategy, decorator]
    secondary: [singleton, adapter, facade, proxy, builder, command pattern]
  context_boost: [refactor, coupling, inheritance, composition, abstraction]
  context_penalty: [frontend, css, ui, styling]
  priority: high
---
