...
/**
 * Get the instincts base directory
 */
...
/**
 * Get project-scoped instincts directory
 * @param {string} projectName - Project name (e.g., 'guaguaguo')
 */
function getProjectInstinctsDir(projectName) {
  return path.join(getInstinctsDir(), 'projects', projectName);
}

/**
 * Get global instincts directory (cross-project)
 */
function getGlobalInstinctsDir() {
  return path.join(getInstinctsDir(), 'global');
}
